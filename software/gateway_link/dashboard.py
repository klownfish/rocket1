...
def main():
    ...
    transmission = tk.Button(settings, text="start transmission", command = gw.start_transmission, **padding)
    ...
    rssi = TextLastValue(settings, "rssi rocket: ", gw.data["rssi_rocket"])
    rssi_gw = TextLastValue(settings, "rssi gateway: ", gw.data["rssi_gateway"])
    ...
    temperature = TextLastValue(settings, "temperature: ", gw.data["temperature"])
